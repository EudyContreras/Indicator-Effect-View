...
public class ParticleRipple extends Particle {
    ...
    public ParticleRipple() {
        super(0, 0, 0, 0, null, null);
    }

    public ParticleRipple(float x, float y, float radius, int color, Paint paint, Bounds bounds) {
        super(x, y, radius, color, paint, bounds);
    }

    public ParticleRipple(float x, float y, float radius, int color, Bounds bounds) {
